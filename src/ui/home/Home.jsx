...
import InvestorCompany from '../../shared/investors/InvestorCompany';
...
const Home = () => {
  return (
    <div className='lg:px-10 md:px-6 px-2'>
      ...
      {/* explore */}
    <Link to="/who-we-are"> <div className='group relative cursor-pointer overflow-hidden bg-white dark:bg-[#121212] dark:border-gray-600 border-[#4169E1] border text-white  my-20 md:11/12 lg:w-9/12 mx-auto py-20 md:py-24 transition-all duration-300 rounded-tl-[50px] md:rounded-tl-[100px] lg:rounded-tl-[145px] rounded-br-[50px] md:rounded-br-[100px] lg:rounded-br-[145px] lg:px-40'>
        <div className='text-container w-full'>
          <h1 className='text-[26px] md:text-[35px] lg:text-[50px] lg:mt-0 md:mt-4 mt-4 font-semibold text-center flex items-center justify-center gap-3 text-[#4169E1] group-hover:text-[#fff] md:gap-7'>Explore Who We Are <FaArrowRightLong className='pt-3 text-[26px] md:text-[30px] md:mt-0 -mt-2 lg:text-[50px] group-hover:text-[#fff] group-hover:ml-2' /></h1>
        </div>
